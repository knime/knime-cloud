...
/**
 * Google Cloud Storage File Picker Node Dialog.
 *
 * @author Sascha Wolke, KNIME GmbH
 */
public class GoogleCSFilePickerNodeDialog extends AbstractFilePickerNodeDialog {

	private ConnectionInformation m_connectionInformation;

	@Override
	protected void checkConnectionInformation(final PortObjectSpec specs) throws NotConfigurableException {
		String error = "Google Cloud Storage connection required";
		if (specs != null) {
			...
			if (m_connectionInformation == null
					|| !m_connectionInformation.getProtocol().equals(GoogleCSRemoteFileHandler.PROTOCOL.getName())) {
	...
	protected String getCfgName() {
		return GoogleCSFilePickerNodeModel.CFG_FILE_SELECTION;
	}
