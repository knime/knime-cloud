...
public abstract class RedshiftGeneralComponents<S extends RedshiftGeneralSettings> {
	...
	protected DialogComponentNumber getPollingComponent() {
		m_pollingInterval = new DialogComponentNumber(m_settings.getPollingModel(), "Polling interval [s]:                                          ", 1);
	...
	public JPanel getDialogPanel() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " " + "AWS Settings" + " "));
    ...
    protected DialogComponentAuthentication defineAuthenticationComponent() {
        ...
        final DialogComponentAuthentication  authComponent = new DialogComponentAuthentication(m_settings.getAuthenticationModel(),
                "Authentication", nameMap,AuthenticationType.USER_PWD, AuthenticationType.CREDENTIALS, AuthenticationType.KERBEROS);
