...
/**
 * Node dialog of the Amazon redshift connector.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
public class RedshiftDBConnectorNodeDialog extends ServerDBConnectorNodeDialog<RedshiftDBConnectorSettings> {

    private static final DBTypeUI DB_TYPE = new DBTypeUI(Redshift.DB_TYPE);

    private static final String HISTORY_PREFIX = "redshift_connector_node_";

    /**
     * Constructs a {@link RedshiftDBConnectorNodeDialog}.
     */
    public RedshiftDBConnectorNodeDialog() {
        super(new RedshiftDBConnectorSettings(),
            ...
            new DatabaseServerLocationPanel<>(HISTORY_PREFIX), Arrays.asList(AuthenticationType.USER_PWD,
