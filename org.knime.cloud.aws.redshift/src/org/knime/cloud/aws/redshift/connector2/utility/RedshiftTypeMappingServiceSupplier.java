...
/**
 * Redshift data type mapping service supplier.
 *
 * @author Tobias Koetter, KNIME GmbH, Konstanz, Germany
 */
public class RedshiftTypeMappingServiceSupplier implements DBTypeMappingServiceSupplier<DBSource, DBDestination> {

    @Override
    public DBTypeMappingService<DBSource, DBDestination> get() {
        return RedshiftTypeMappingService.getInstance();
    }
