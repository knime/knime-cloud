 ...
 */
public class RedshiftDBConnectorSettings extends ServerDBConnectorSettings {

    private static final DBType DB_TYPE = Redshift.DB_TYPE;
     ...
     *
     */
    public RedshiftDBConnectorSettings() {
        super("redshift-connection");
