 ...
 */
public class CloudConnectionInformationPortObjectSpec extends ConnectionInformationPortObjectSpec {

	public static final class Serializer
		extends AbstractSimplePortObjectSpecSerializer<CloudConnectionInformationPortObjectSpec> { };
     ...
     */
    public CloudConnectionInformationPortObjectSpec() {
     ...
     */
    public CloudConnectionInformationPortObjectSpec(final CloudConnectionInformation connectionInformation) {
    ...
    protected void load(final ModelContentRO model) throws InvalidSettingsException {
        m_connectionInformation = CloudConnectionInformation.load(model);
    }
}
