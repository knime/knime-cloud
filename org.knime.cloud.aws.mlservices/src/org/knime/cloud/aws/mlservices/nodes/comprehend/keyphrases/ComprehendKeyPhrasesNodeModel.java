...
/**
 * The {@code NodeModel} for node that extracts entities from text using the Amazon Comprehend service.
 *
 * @author Jim Falgout, KNIME AG, Zurich, Switzerland
 */
final class ComprehendKeyPhrasesNodeModel extends BaseComprehendLangNodeModel {
    ...
    protected ComprehendOperation getOperationInstance(final CloudConnectionInformation cxnInfo,
        ...
        return new KeyPhrasesOperation(cxnInfo, textColumn, sourceLanguage, outputSpec);
    }

    @Override
    public DataTableSpec generateOutputTableSpec(final DataTableSpec inputSpec) {
        // Define the new columns to be added.
        final DataColumnSpec[] allColSpecs = new DataColumnSpec[4];
