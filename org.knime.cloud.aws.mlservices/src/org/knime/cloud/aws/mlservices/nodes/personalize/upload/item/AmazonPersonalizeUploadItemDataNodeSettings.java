...
/**
 * Node settings for Amazon Personalize item data upload node.
 *
 * @author Simon Schmid, KNIME GmbH, Konstanz, Germany
 */
final class AmazonPersonalizeUploadItemDataNodeSettings extends AbstractAmazonPersonalizeDataUploadNodeSettings {
    ...
    public void loadSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        setItemIDColumnName(settings.getString(CFG_KEY_ITEMID_COLUMN_NAME));
    }
    ...
    public void loadSettingsForDialog(final NodeSettingsRO settings, final DataTableSpec spec) {
        ...
        setItemIDColumnName(settings.getString(CFG_KEY_ITEMID_COLUMN_NAME, DEF_ITEMID_COLUMN_NAME));
    }
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        ...
        settings.addString(CFG_KEY_ITEMID_COLUMN_NAME, getItemIDColumnName());
    }
    ...
    protected String getDatasetType() {
        return AmazonPersonalizeUploadItemDataNodeModel.DATATYPE;
    }
