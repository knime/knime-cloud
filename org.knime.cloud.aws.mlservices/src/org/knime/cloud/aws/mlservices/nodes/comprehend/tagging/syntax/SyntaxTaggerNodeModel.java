...
import org.knime.cloud.aws.mlservices.nodes.comprehend.tagging.ComprehendTaggerNodeModel;
 ...
 */
class SyntaxTaggerNodeModel extends ComprehendTaggerNodeModel {
    ...
    protected ComprehendTaggerOperation getOperationInstance(final CloudConnectionInformation cxnInfo,
        ...
        final String tokenizerName, final String newDocCol) {
        // Return a new syntax tagger operation
        return new SyntaxTaggerOperation(cxnInfo, textColumn, sourceLanguage, tokenizerName, newDocCol, outputSpec);
    }
}
