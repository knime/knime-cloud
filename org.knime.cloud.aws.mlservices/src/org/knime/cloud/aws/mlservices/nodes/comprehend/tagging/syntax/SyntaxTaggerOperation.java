 ...
 * {@code Document} column that is to be analyzed and applies the syntax tagger to the document. The AWS Comprehend
 ...
 */
class SyntaxTaggerOperation extends ComprehendTaggerOperation {

    /**
     * Creates a new instance of {@code SyntaxTaggerOperation}
     *
     ...
     */
    SyntaxTaggerOperation(final CloudConnectionInformation cxnInfo, final String textColumnName,
    ...
    protected DocumentTagger getTagger(final AmazonComprehend comprehendClient, final String languageCode,
        ...
        return new SyntaxTagger(comprehendClient, languageCode, tokenizerName);
    }
}
