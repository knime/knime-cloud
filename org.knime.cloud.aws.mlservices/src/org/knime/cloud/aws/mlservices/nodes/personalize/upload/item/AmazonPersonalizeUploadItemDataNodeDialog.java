...
/**
 * Node dialog for Amazon Personalize item data upload node.
 *
 * @author Simon Schmid, KNIME GmbH, Konstanz, Germany
 */
final class AmazonPersonalizeUploadItemDataNodeDialog
    extends AbstractAmazonPersonalizeDataUploadNodeDialog<AmazonPersonalizeUploadItemDataNodeSettings> {
     ...
     */
    @Override
    protected AmazonPersonalizeUploadItemDataNodeSettings createSettings() {
