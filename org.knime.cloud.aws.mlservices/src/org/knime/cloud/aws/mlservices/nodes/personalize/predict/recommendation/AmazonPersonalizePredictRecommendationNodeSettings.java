...
/**
 * The node settings of the Amazon Personalize recommendation nodes.
 *
...
public final class AmazonPersonalizePredictRecommendationNodeSettings extends AmazonPersonalizePredictNodeSettings {
    ...
    private static final int DEF_NUM_RESULTS = 25;

    private int m_numResults = DEF_NUM_RESULTS;
    ...
    public void loadSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_numResults = settings.getInt(CFG_KEY_NUM_RESULTS);
    }
    ...
    public void loadSettingsForDialog(final NodeSettingsRO settings) {
        ...
        m_numResults = settings.getInt(CFG_KEY_NUM_RESULTS, DEF_NUM_RESULTS);
    }
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        ...
        settings.addInt(CFG_KEY_NUM_RESULTS, m_numResults);
    }
