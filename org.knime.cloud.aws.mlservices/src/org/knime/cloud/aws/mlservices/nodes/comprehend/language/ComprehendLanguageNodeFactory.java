...
/**
 * The {@link NodeFactory} for the "Amazon Dominant Language" node
 *
 * @author Jim Falgout, KNIME AG, Zurich, Switzerland
 */
public class ComprehendLanguageNodeFactory extends NodeFactory<ComprehendLanguageNodeModel> {
	...
	public NodeDialogPane createNodeDialogPane() {
		return new BaseComprehendNodeDialog(false);
	}
