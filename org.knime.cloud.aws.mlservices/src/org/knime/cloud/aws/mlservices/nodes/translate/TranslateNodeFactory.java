...
/**
 * {@code NodeFactory} for the AWS Translate Node.
 *
 * @author Jim Falgout, KNIME AG, Zurich, Switzerland
 */
public class TranslateNodeFactory extends NodeFactory<TranslateNodeModel> {
    ...
    @Override
    public NodeView<TranslateNodeModel> createNodeView(final int viewIndex, final TranslateNodeModel nodeModel) {
        return null;
    }
