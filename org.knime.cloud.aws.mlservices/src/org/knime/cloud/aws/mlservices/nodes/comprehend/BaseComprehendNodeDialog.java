...
/**
 * Node dialog for Amazon comprehend nodes.
 *
 * @author Julian Bunzel, KNIME GmbH, Berlin, Germany
 */
public class BaseComprehendNodeDialog extends DefaultNodeSettingsPane {

    /**
     * Creates a new instance of {@link BaseComprehendNodeDialog}.
     *
     * @param showLanguage If true, a component to select the text's source language is available
     */
    @SuppressWarnings("unchecked")
    public BaseComprehendNodeDialog(final boolean showLanguage) {
        addDialogComponent(new DialogComponentColumnNameSelection(ComprehendUtils.getTextColumnNameModel(),
            "Text column", 1, StringValue.class));
        if (showLanguage) {
