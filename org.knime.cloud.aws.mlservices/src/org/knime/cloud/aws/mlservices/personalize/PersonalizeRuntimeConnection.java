 ...
 * @author
 */
public class PersonalizeRuntimeConnection extends Connection {

    /** Logger instance. */
    private static final NodeLogger LOGGER = NodeLogger.getLogger(PersonalizeRuntimeConnection.class);
     ...
     */
    private static final AmazonPersonalizeRuntime getPersonalizeRuntimeClient(final CloudConnectionInformation connectionInformation)
        throws Exception {
        final ClientConfiguration clientConfig =
            new ClientConfiguration().withConnectionTimeout(connectionInformation.getTimeout());

        final AmazonPersonalizeRuntimeClientBuilder builder =
    ...
    private static final AmazonPersonalizeRuntime
        getRoleAssumedPersonalizeRuntimeClient(final CloudConnectionInformation connectionInformation) throws Exception {
