 ...
 * @author
 */
public enum AmazonEntityTag implements TagBuilder {
    /** A branded product */
    COMMERCIAL_ITEM,
     ...
     */
    public static final String TAG_TYPE = "ENTITY";

    /**
     * Creates new instance of {@code AmazonEntityTag}.
     */
    private AmazonEntityTag() {
        m_tag = new Tag(name(), TAG_TYPE);
    }

    /**
     * @return The {@link org.knime.ext.textprocessing.data.Tag} corresponding to the specified {@code AmazonEntityTag}.
     */
    public Tag getTag() {
        return m_tag;
    }
    ...
    public List<String> asStringList() {
        Enum<AmazonEntityTag>[] values = values();
    ...
    public static Tag stringToTag(final String str) {
        for (AmazonEntityTag pos : values()) {
            if (pos.getTag().getTagValue().equals(str)) {
                return pos.getTag();
            }
        }
        return AmazonEntityTag.OTHER.getTag();
    }
    ...
    /**
     * @return The default "OTHER" {@code AmazonEntityTag} as {@code TagBuilder}.
     */
    public static TagBuilder getDefault() {
        return AmazonEntityTag.OTHER;
    }
    ...
    public Set<Tag> getTags() {
        ...
        for (AmazonEntityTag tag : values()) {
