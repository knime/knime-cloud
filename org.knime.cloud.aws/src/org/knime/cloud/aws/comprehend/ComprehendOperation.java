...
public interface ComprehendOperation {
     ...
     * @throws CanceledExecutionException thrown if the execution is canceled during execution
     * @throws InterruptedException thrown if the operation is interrupted (can happen when another streaming node fails)
     */
    BufferedDataTable compute(final ExecutionContext exec, final BufferedDataTable data) throws CanceledExecutionException, InterruptedException;

    /**
     * Compute method for a streaming operation. Executes the operation on all data contained in the stream.
     *
