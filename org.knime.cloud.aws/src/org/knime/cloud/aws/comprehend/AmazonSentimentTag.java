...
/**
 * Sentiment tags used by the Amazon Comprehend service.
 *
 * @author
 */
public enum AmazonSentimentTag implements TagBuilder {
    /** Mixed sentiment (positive and negative) */
    MIXED,
    /** Positive sentiment */
    POSITIVE,
    /** Neutral sentiment */
    ...
    /** Negative sentiment */
    NEGATIVE,
    /** Unknown sentiment (not supported by AWS, but needed) */
    UNKNOWN;

    private final Tag m_tag;

    /**
     * The constant for Amazon Sentiment tag types.
     */
    public static final String TAG_TYPE = "SENTIMENT";

    /**
     * Creates new instance of {@code AmazonSentimentTag}.
     */
    private AmazonSentimentTag() {
        m_tag = new Tag(name(), TAG_TYPE);
    }

    /**
     * @return The {@link org.knime.ext.textprocessing.data.Tag} corresponding to the specified {@code AmazonSentimentTag}.
     */
    public Tag getTag() {
        return m_tag;
    }
    ...
    public List<String> asStringList() {
        Enum<AmazonSentimentTag>[] values = values();
    ...
    public static Tag stringToTag(final String str) {
        for (AmazonSentimentTag pos : values()) {
            if (pos.getTag().getTagValue().equals(str)) {
                return pos.getTag();
            }
        }
        return AmazonSentimentTag.UNKNOWN.getTag();
    }
    ...
    public Tag buildTag(final String value) {
        return AmazonSentimentTag.stringToTag(value);
    }

    /**
     * @return The default "UNKNOWN" {@code AmazonSentimentTag} as {@code TagBuilder}.
     */
    public static TagBuilder getDefault() {
        return AmazonSentimentTag.UNKNOWN;
    }
    ...
    public Set<Tag> getTags() {
        ...
        for (AmazonSentimentTag tag : values()) {
