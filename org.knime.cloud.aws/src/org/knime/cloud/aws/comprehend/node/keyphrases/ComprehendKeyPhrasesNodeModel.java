 ...
 */
public class ComprehendKeyPhrasesNodeModel extends NodeModel {
    ...
    private final SettingsModelString textColumnName =
            new SettingsModelString(
                ComprehendKeyPhrasesNodeModel.CFGKEY_COLUMN_NAME,
                "text");

    private final SettingsModelString sourceLanguage =
            new SettingsModelString(
                ComprehendKeyPhrasesNodeModel.CFGKEY_SOURCE_LANG,
                "English");
     ...
     */
    protected ComprehendKeyPhrasesNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        final KeyPhrasesOperation entityOp =
                new KeyPhrasesOperation(
                    cxnInfo,
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        DataTableSpec outputSpec = KeyPhrasesOperation.createDataTableSpec(textColumnName.getStringValue());
