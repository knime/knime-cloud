 ...
 */
public class ComprehendSyntaxNodeModel extends NodeModel {
    ...
    private final SettingsModelString textColumnName =
            new SettingsModelString(
                ComprehendSyntaxNodeModel.CFGKEY_COLUMN_NAME,
                "text");

    private final SettingsModelString sourceLanguage =
            new SettingsModelString(
                ComprehendSyntaxNodeModel.CFGKEY_SOURCE_LANG,
                "English");
     ...
     */
    protected ComprehendSyntaxNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        final SyntaxOperation syntaxOp =
                new SyntaxOperation(
                    cxnInfo,
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        DataTableSpec outputSpec = SyntaxOperation.createDataTableSpec(textColumnName.getStringValue());
