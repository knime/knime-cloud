 ...
 */
public class ComprehendSentimentNodeModel extends NodeModel {
    ...
    private final SettingsModelString textColumnName =
            new SettingsModelString(
                ComprehendSentimentNodeModel.CFGKEY_COLUMN_NAME,
                "text");

    private final SettingsModelString sourceLanguage =
            new SettingsModelString(
                ComprehendSentimentNodeModel.CFGKEY_SOURCE_LANG,
                "English");
     ...
     */
    protected ComprehendSentimentNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        final SentimentOperation syntaxOp =
                new SentimentOperation(
                    cxnInfo,
        ...
        BufferedDataTable[] result = new BufferedDataTable[] { syntaxOp.compute(exec, table) };
        return result;
    }
    /**
     * {@inheritDoc}
    ...
    public StreamableOperator createStreamableOperator(final PartitionInfo partitionInfo, final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        return new StreamableOperator() {
            ...
            public void runFinal(final PortInput[] inputs, final PortOutput[] outputs, final ExecutionContext exec)
                ...
                syntaxOp.compute(input, output, exec, 0L);
                input.close();
                output.close();
            }
        };
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        DataTableSpec outputSpec = SentimentOperation.createDataTableSpec(textColumnName.getStringValue());
