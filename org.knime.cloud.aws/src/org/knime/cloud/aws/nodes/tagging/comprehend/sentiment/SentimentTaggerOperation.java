 ...
 * @author KNIME AG
 */
class SentimentTaggerOperation extends BaseComprehendOperation {
    // Language of the source text to be analyzed
    private final String m_sourceLanguage;
    private final String m_tokenizerName;

    SentimentTaggerOperation(final ConnectionInformation cxnInfo, final String textColumnName, final String sourceLanguage, final String tokenizerName, final DataTableSpec outputSpec) {
    ...
    public void compute(final RowInput in, final RowOutput out, final ExecutionContext exec, final long rowCount) throws CanceledExecutionException, InterruptedException {
        ...
        // Create the tagger that uses the detect sentiment capability of the Comprehend service.
        ...
        while ((inputRow = in.poll()) != null) {
         // Check for cancel and update the row progress
            ...
            // Apply the tagger to the input document.
