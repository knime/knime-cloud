 ...
 * @author KNIME AG
 */
class SyntaxTaggerOperation extends BaseComprehendOperation {

    // Language of the source text to be analyzed
    private final String m_sourceLanguage;
    private final String m_tokenizerName;

    SyntaxTaggerOperation(final ConnectionInformation cxnInfo,final String textColumnName, final String sourceLanguage, final String tokenizerName, final DataTableSpec outputSpec) {
